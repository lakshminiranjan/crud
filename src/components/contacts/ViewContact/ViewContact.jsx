                ...
                <div className="container">
                    <div className="row">
                        <div className="col">
                            ...
                            <p className="fst-italic">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nostrum at atque temporibus magni omnis aliquid veniam, tempore doloribus quaerat aut nihil assumenda quod ipsum vitae? Reiciendis similique voluptatum sit ipsam.</p>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-8">
                                        <ul className="list-group">
                                            ...
                                            <li className="list-group-item list-group-item-action">
                                                Mobile : <span className="fw bold">1111111111</span>
                                            </li>
                                            <li className="list-group-item list-group-item-action">
